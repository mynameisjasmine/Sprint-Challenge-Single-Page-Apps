...
> Answer: Less data is processed so page loading is faster
- [ ] What does AJAX stand for?
> Answer: Asynchronous JavaScript and XML
- [ ] What are `controlled components` in React?
> Answer: Functions that save data to state in a parent component and can be passed to a child component via props
